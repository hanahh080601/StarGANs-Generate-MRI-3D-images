...
class CustomDataset(data.Dataset):
    ...
    def __init__(self, image_dir, patch_size, stride, image_size, transform, mode):
        ...
        self.attr2idx = {}
        self.idx2attr = {}
        self.num_patches = math.ceil((self.image_depth - self.patch_size + self.stride) / self.stride) ** 3
        self.preprocess()
    ...
    def __getitem__(self, index):
        ...
        filename, label = dataset[image_index]        
        ...
        sub_index = index%self.num_patches
        return patches[sub_index], torch.FloatTensor(label)
